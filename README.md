About sardana-adlink-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sardana-adlink-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sardana-adlink-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sardana-adlink
# for installing globally
pixi global install sardana-adlink
```
...
It is possible to list all of the versions of `sardana-adlink` available on your platform:
...
```
pixi search sardana-adlink --channel conda-forge
```
